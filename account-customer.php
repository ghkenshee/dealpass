        ...
        <div class="flex min-h-screen">
            <div class="w-20 md:w-64 bg-white p-4 flex flex-col md:fixed md:top-0 md:left-0 md:h-screen border-r border-gray-100 border-gray-300 shadow-sm z-10">
                ...
                <nav class="flex-1 flex flex-col w-full space-y-2">
                    <a href="dashboard-customer.php" class="flex items-center w-full p-2 rounded-xl text-gray-500 hover:text-red-600 font-medium text-lg transition duration-150 justify-center md:justify-start">
                    ...
                    <a href="account-customer.php" class="flex items-center w-full p-2 rounded-xl font-bold text-lg text-red-600 transition duration-150 justify-center md:justify-start">
                        <svg class="h-7 w-7 md:mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="w-full max-w-3xl p-10 md:p-16 space-y-12">
                    <h1 class="text-4xl font-extrabold text-gray-900">
                        ...
                        <div class="flex items-center gap-4 pt-4">
                            <a href="login-customer.php?logout=true" class="bg-[#D30000] hover:bg-red-800 text-white text-lg font-bold py-3 px-10 rounded-full transition duration-300">
                                Log Out
                            </a>
